...
class SettingService
{
    ...
    public function getPublicIdentity(?OrganizationProfile $profile = null): array
    {
        ...
        return [
            'site_title' => $this->getValue('site_title', $organizationName),
            'site_description' => $this->getValue('site_description', $description),
            'footer_text' => $this->getValue('footer_text', '(c) '.$organizationName),
            'default_meta_description' => $this->getValue('default_meta_description', $description),
            'contact_email' => $this->getValue('contact_email', $profile?->email),
            'contact_phone' => $this->getValue('contact_phone', $profile?->phone),
            'instagram_url' => $this->getValue('instagram_url', $profile?->instagram_url),
            'youtube_url' => $this->getValue('youtube_url', $profile?->youtube_url),
        ];
    }
