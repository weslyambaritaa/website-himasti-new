...
export default function OrganizationProfileEditPage() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        logo: null,
        chairman_message: profile?.chairman_message ?? "",
        ...
        <AppLayout>
            <div className="space-y-6">
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <FormSection title="Konten Publik" description="Konten ini ditampilkan pada halaman profil dan landing page.">
                        <div className="grid gap-4">
                            {[
                                ...
                                ["vision", "Visi", 4],
                                ["mission", "Misi", 4],
                                ["chairman_message", "Sambutan Ketua", 5],
                                ["address", "Alamat", 3],
                            ].map(([key, label, rows]) => (
                                <div key={key} className="grid gap-2">
                                    <Label htmlFor={key}>{label}</Label>
