    ...
    return (
        <PublicLayout
            pageHeader={{
                kicker: "Struktur",
                title: "Divisi",
                description: "Struktur divisi HIMASTI beserta peran dan fokus kerjanya.",
            }}
        >
                ...
                <div className="public-container space-y-10">
                    {divisions.data.length ? (
                            ...
                            <div className="grid gap-10 md:grid-cols-2 xl:grid-cols-3">
                                {divisions.data.map((item) => (
                                    <EditorialCard
                                        ...
                                        meta={`${item.members_count ?? 0} anggota`}
                        ...
                        <EmptyPublicState
                            ...
                            description="Divisi aktif akan muncul di sini setelah datanya tersedia."
                        />
                    )}
                </div>
            </section>
