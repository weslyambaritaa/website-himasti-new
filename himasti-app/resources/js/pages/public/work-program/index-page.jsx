        ...
        >
            <section className="public-section bg-white">
                <div className="public-container space-y-10">
                    <form onSubmit={submit} className="grid gap-4 rounded-2xl border border-slate-200 bg-[#F4F6FA] p-5 md:grid-cols-3" data-reveal>
                        ...
                        <Button type="submit" className="rounded-xl bg-[#1C2032] text-white hover:bg-[#292f49]">
                            Terapkan Filter
                        </Button>
                    </form>
                            ...
                            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                                {workPrograms.data.map((item) => (
                                    <EditorialCard
                                        ...
                                        badge={item.is_featured ? "Program Unggulan" : null}
