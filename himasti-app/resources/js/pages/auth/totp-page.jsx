...
export default function TOTPPage() {
    const { appName, publicProfileMeta, publicIdentity } = usePage().props;
    ...
    return (
        <div className="flex min-h-svh flex-col items-center justify-center gap-6 bg-[#F4F6FA] p-6 md:p-10">
            <div className="flex w-full max-w-sm flex-col gap-6">
                <div className="w-full max-w-xs">
                    <Card>
                        <CardHeader className="text-center">
                            <div className="mx-auto rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-sm">
                                <img
                                    src={logoSrc}
                                    alt={
                                    ...
                                    className="mx-auto h-24 w-auto max-w-[15rem] object-contain"
                                />
                            </div>
